      ...
      <div class="beforeString">
        <div class="string">
         <div class="row">
            ...
            <div>
              <input type="text" id="surname" name="secondname" placeholder="Иванов" required>
            </div>
          </div>
          ...
          <div class="row">
            ...
            <div>
              <input type="text" id="name" name="firstname" placeholder="Иван" required>
            </div>
          </div>
          ...
          <div class="row row__gender">
            ...
            <select id="gender" class="genderSelect" required>
              <option>    </option>
              <option>Муж.</option>
              <option>Жен.</option>
            </select>
        ...
        <div class="string string__dateAndTel">
          <div class="row">
            ...
            <div>
              <input type="date" id="date" date-format="dd/mm/yyyy" required pattern="[0-9]{4}-[0-9]{2}-[0-9]{2}">
            </div>
          </div>
          ...
          <div class="row">
            ...
            <div>
              <input type="tel" id="tel" name="tel" pattern="+7([0-9]{3})-[0-9]{3}-[0-9]{2}-[0-9]{2}" placeholder="Телефон" required>
            </div>
          </div>
